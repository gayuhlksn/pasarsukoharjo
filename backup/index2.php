...
<head>
  ...
  <title>SIG PEMETAAN PASAR TRADISIONAL KABUPATEN SUKOHARJO</title>
...
<body>
    ...
    <div class="container">
      <div class="header-container d-flex align-items-center">
        <div class="logo mr-auto">
          <!-- <h1 class="text-light"><a href="index2.php"><span>SIG</span></a></h1>-->
        ...
        <nav class="nav-menu d-none d-lg-block">
          <ul>
            ...
            <li><a href="#portfolio">Data Pasar Tradisional</a></li>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container text-center position-relative" data-aos="fade-in" data-aos-delay="200">
      ...
      <h1>PEMETAAN PASAR TRADISIONAL</h1>
      ...
      <div class="container">
        ...
        <div class="row content">
          <div class="col-lg-6" data-aos="fade-right" data-aos-delay="100">
            <h2>SIG PASAR TRADISIONAL KABUPATEN SUKOHARJO</h2>
            <h3>Sistem informasi ini merupakan aplikasi pemetaan persebaran pasar tradisional di Kabupaten Sukoharjo. Aplikasi ini memuat informasi dan lokasi dari pasar tradisional di Kabupaten Sukoharjo.</h3>
          </div>
    ...
    <section id="cta" class="cta">
      <div class="container">
        ...
        <div class="text-center" data-aos="zoom-in">
          <h3>SISTEM INFORMASI GEOGRAFIS OBJEK pasar BANYUMAS</h3>
          <p> Detail tempat pasar di Banyumas</p>
        ...
        <div class="row">
          <div class="col-lg-3" data-aos="fade-right">
            <div class="section-title">
              <h2>Data pasar</h2>
              <p>Halaman ini memuat informasi Tempat pasar di Kabupaten Banyumas </p>
            </div>
          </div>
